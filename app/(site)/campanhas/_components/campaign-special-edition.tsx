 ...
 * `0.8fr_1.2fr`, mesma capa em vídeo tocando com controle de pausa e botão de
 * virar o exemplar (`BookCoverFlip`), mesmo CTA de carrinho. A página já
 * ensinou o leitor a ler esse bloco como "o exemplar"; a edição limitada é o
 * mesmo exemplar com outra capa, então mudar o layout aqui só sugeriria um
 * produto de outra natureza. O que separa as duas é o kicker e a posição —
 * esta vem depois de tudo, atrás de uma `border-t`, como último passo da
 * leitura.
 *
